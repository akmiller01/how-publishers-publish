...
if __name__ == "__main__":
    ...
    indicators = [
        ...
        ("Number of activities with recipient country or recipient region", "B124", "iati-activity[recipient-country[(string-length(@code) > 0)]|recipient-region[(string-length(@code) > 0)]]", "len"),
        ("Number of activities with recipient country", "B125", "iati-activity[recipient-country[(string-length(@code) > 0)]]", "len"),
        ("Number of activities with recipient region", "B126", "iati-activity[recipient-region[(string-length(@code) > 0)]]", "len"),
        ("Number of activities with recipient country and recipient region", "B127", "iati-activity[recipient-country[(string-length(@code) > 0)] and recipient-region[(string-length(@code) > 0)]]", "len"),
        ("Number of transactions in activities with recipient country or recipient region", "B128", "iati-activity[recipient-country[(string-length(@code) > 0)]|recipient-region[(string-length(@code) > 0)]]/transaction", "len"),
        ("Number of transactions with recipient country", "B129", "iati-activity/transaction[recipient-country[(string-length(@code) > 0)]]", "len"),
        ("Number of transactions with recipient region", "B130", "iati-activity/transaction[recipient-region[(string-length(@code) > 0)]]", "len"),
        ("Number of activities with transactions that have recipient country and recipient region", "B131", "iati-activity[transaction[recipient-country[(string-length(@code) > 0)]|recipient-region[(string-length(@code) > 0)]]]", "len"),
